...
export class SevicesComponent implements OnInit {
  ...
  quetionList1: any = [
    ...
    },
    {
      ...
      description:
        'उत्तर: हाँ बिल्कुल! मन और शरीर के बीच एक पारस्परिक संबंध है। तनाव से कोर्टिसोल का स्राव होता है जो विभिन्न शारीरिक कार्यों जैसे श्वसन, पाचन, चयापचय आदि पर नकारात्मक प्रभाव डालता है।',
    },
  ];
  constructor(
